...
<head>
	...
	<meta charset="utf-8"/>
	<title>szkoła gimnazjalna</title>
...
<body>
	...
	<div id="container">
		...
		<div class="school"><i class="icon-pen"></i>Szkoła gimnazjalna</div>
		...
		<div id="page">
		<div id="sidebar">
		<div class="Subjects"><a href=gimnazjum.php class="but">Wszystkie</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=biologia class="but">Biologia</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=chemia class="but">Chemia</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=fizyka class="but">Fizyka</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=geografia class="but">Geografia</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=historia class="but">Historia</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=informatyka class="but">Informatyka</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=angielski class="but">J. angielski</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=niemiecki class="but">J. niemiecki</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=polski class="but">J. polski</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=matematyka class="but">Matematyka</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=muzyka class="but">Muzyka</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=plastyka class="but">Plastyka</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=technika class="but">Technika</a></div>
		<div class="Subjects"><a href=gimnazjum.php?przedmiot=wos class="but">WOS</a></div>
		</form>
		</div>
		...
		<div id="content">
			...
			<?php
					...
					else
					{
						...
						$query = "SELECT * FROM ogloszenia WHERE szkola='gimnazjum'";
