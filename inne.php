...
<head>
	...
	<meta charset="utf-8"/>
	<title>szkolnictwo wyższe</title>
...
<body>
	...
	<div id="container">
		...
		<div class="school"><i class="icon-graduation-cap"></i>Szkolnictwo wyższe</div>
		...
		<div id="page">
		<div id="sidebar">
		<div class="Subjects"><a href=inne.php class="but">Wszystkie<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=biologia class="but">Biologia<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=chemia class="but">Chemia<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=fizyka class="but">Fizyka<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=geografia class="but">Geografia<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=historia class="but">Historia<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=angielski class="but">J. angielski<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=matematyka class="but">Matematyka<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=plyny class="but">Mechanika płynów<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=programowanie class="but">Programowanie<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=przetwarzanie class="but">Przetwarzanie obrazów<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=robotyka class="but">Robotyka<a/></div>
		<div class="Subjects"><a href=inne.php?przedmiot=automatyka class="but">Automatyka<a/></div>
		</form>
		</div>
		...
		<div id="content">
			...
			<?php
				...
				else
				{
					...
					$query = "SELECT * FROM ogloszenia WHERE szkola='inne'";
